    ...
    for key in answers:
        ...
        for inner_idx, answer in enumerate(answers[key]):
            if 'value' in answer:
                ...
                print(redaction.reference_id,'redaction.reference_id')
                if key == redaction.reference_id:
                    print(answer['value'],'answer')
                    print(redaction.permanent_redaction,'redaction.permanent_redaction')
                    answer['value'] = redact_content(answer['value'], redaction.permanent_redaction)
                    return
            else:
...
def db_redact_whistleblower_identity(session, tid, user_id, itip_id, redaction, redaction_data, tip_data,rtip):
    ...
    print("aaaaaaaaaa")
    print("aaaaaaaaaa")
    print(new_permanent_redaction,"redaction")
    print(whistleblower_identity,"tip_data before")
    db_redact_whistleblower_identities(whistleblower_identity, redaction)
    _content = whistleblower_identity
    print(_content,"tip_data after")
    print("aaaaaaaaaa")
    print("aaaaaaaaaa")
    print("aaaaaaaaaa")
    if itip_id.crypto_tip_pub_key:
